...
alias vbash2='nvim ~/.bash/user_specific.sh'
alias vbash3='nvim ~/.bash/alias.sh'
alias vlog='nvim ~/Dropbox/articles/logs/log.txt'
alias llog='less ~/Dropbox/articles/logs/log.txt'
alias sbash='source ~/.bashrc'
alias vvim='nvim ~/.config/nvim/init.lua'
alias gno='xdg-open .'
alias vim='nvim'
alias v='nvim'
alias g='gedit'
